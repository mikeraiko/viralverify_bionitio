...
this_program_name="viralverify_bionitio-test.sh"
...
${this_program_name}: run integration/regression tests for viralverify_bionitio 

Usage:
    ${this_program_name} [-h] [-v] -p program -d test_data_dir 

Example:
    ${this_program_name} -p bin/viralverify_bionitio -d data/tests
